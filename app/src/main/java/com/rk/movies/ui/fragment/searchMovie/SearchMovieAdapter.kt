...
import com.rk.movies.databinding.SearchmovieItemBinding
...
class SearchMovieAdapter(
    ...
    public val list: ArrayList<Result>,
) : RecyclerView.Adapter<SearchMovieAdapter.ViewHolder>() {

    var tag = "SearchMovieAdapter"
    lateinit var binding: SearchmovieItemBinding

    // create new views
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        // inflates the card_view_design view
        // that is used to hold list item
        binding = SearchmovieItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
