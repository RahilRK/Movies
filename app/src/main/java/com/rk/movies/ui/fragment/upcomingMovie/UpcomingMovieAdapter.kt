...
import com.rk.movies.databinding.NowplayingItemBinding
import com.rk.movies.databinding.UpcomingmovieItemBinding
...
class UpcomingMovieAdapter(
    ...
    private val onClick: movieListOnClick,
) : RecyclerView.Adapter<UpcomingMovieAdapter.ViewHolder>() {

    var tag = "UpcomingMovieAdapter"
    lateinit var binding: UpcomingmovieItemBinding

    // create new views
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        // inflates the card_view_design view
        // that is used to hold list item
        binding = UpcomingmovieItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
